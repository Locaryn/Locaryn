    ...
    private fun setupCamera(cameraDirection: String, windowed: Boolean) {
        activity
            .runOnUiThread {
                ...
                // Correctif Locaryn : le mode par défaut (PERFORMANCE) dessine
                // l'aperçu dans un SurfaceView en z-order-on-top. Android ajoute
                // alors un filtre tactile défensif à la fenêtre entière — même
                // le bouton natif d'annulation posé par-dessus cessait de
                // répondre, laissant le seul bouton retour comme échappatoire.
                // COMPATIBLE compose l'aperçu comme une vue normale, sans ce
                // z-order spécial, et rend la fenêtre de nouveau tactile.
