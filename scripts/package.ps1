# Lochor packaging helper (Windows).
...
Write-Host "[Lochor] Packaging artifacts for $Target" -ForegroundColor Cyan
...
if ($Found) {
    $Archive = Join-Path $ReleaseDir "lochor-servers-$Target.zip"
