...
let demoExtensions: InstalledExtension[] = [
  ...
  },
  {
    ...
    scope: "user",
    ecosystem: "locaryn",
    source: "github:Locaryn/morph-dictaphone",
    install_dir: "~/.locaryn/plugins/morph-dictaphone",
    enabled: true,
    components: {
      skills: 0,
      commands: 0,
  ...
  },
  {
    ...
    scope: "user",
    ecosystem: "locaryn",
    source: "github:Locaryn/morph-image",
    install_dir: "~/.locaryn/plugins/morph-image",
    enabled: true,
    components: {
      skills: 1,
      commands: 0,
