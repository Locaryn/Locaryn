...
let demoExtensions: InstalledExtension[] = [
  ...
  {
    id: "demo-dictaphone",
    name: "extension-dictaphone",
    display_name: "extension-dictaphone",
    version: "1.0.0",
    api_version: "0.1",
    description: "Dictaphone et transcription vocale en temps réel pour le chat",
    author: "Locaryn Contributor",
    homepage: "https://github.com/Locaryn/extension-dictaphone",
    kind: "plugin",
    scope: "user",
    ecosystem: "locaryn",
    source: "github:Locaryn/extension-dictaphone",
    install_dir: "~/.locaryn/plugins/extension-dictaphone",
    enabled: true,
    components: {
      skills: 0,
      commands: 0,
  ...
  },
  {
    ...
    display_name: "extension-image",
    version: "1.4.6",
    api_version: "0.1",
    description:
      "Génération et modification d'images avec son moteur stable-diffusion.cpp, ses modèles et son interface",
    author: "Locaryn Team",
    homepage: "https://github.com/Locaryn/extension-image",
    kind: "plugin",
    scope: "user",
    ecosystem: "locaryn",
    source: "github:Locaryn/extension-image",
    install_dir: "~/.locaryn/plugins/extension-image",
    enabled: true,
    components: {
      skills: 1,
      commands: 0,
