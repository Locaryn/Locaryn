...
export const MODEL_CATALOG: ModelFamily[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "Gemma 4",
    brand: "Google",
    description: "Famille multimodale de dernière génération (texte, image, audio). Architecture encoder-free unifiée avec function calling natif.",
    license: "Apache-2.0",
    contextWindow: "256k",
    releaseDate: "2026-04",
    releaseYear: 2026,
    ...
    finetunable: true,
    variants: [
      { size: "E2B (Edge)", params: 2, tag: "gemma4:e2b", quants: QUANTS_SMALL, storageGb: 1.6, instruct: true },
      { size: "E4B (Edge)", params: 4, tag: "gemma4:e4b", quants: QUANTS_SMALL, storageGb: 2.8, instruct: true },
  ...
  },
  {
    ...
    name: "Gemma 2",
    brand: "Google",
    description: "Modèles légers ultra-performants de Google (variantes officielles 2B, 9B et 27B).",
    license: "Gemma Terms",
    contextWindow: "8k",
    releaseDate: "2024-06",
    releaseYear: 2024,
  ...
  },
  {
    ...
    name: "CodeGemma",
    brand: "Google",
    description: "Modèles officiels Google spécialisés pour la complétion et la génération de code.",
    license: "Gemma Terms",
    contextWindow: "8k",
    releaseDate: "2024-04",
    releaseYear: 2024,
    ...
    instruct: true,
    variants: [
      { size: "2B", params: 2, tag: "codegemma:2b", quants: QUANTS_SMALL, storageGb: 1.6, instruct: true },
      { size: "7B", params: 7, tag: "codegemma:7b", quants: QUANTS_SMALL, storageGb: 5.0, instruct: true },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "Qwen3",
    brand: "Alibaba / Qwen",
    description: "Famille flagship multilingue (119+ langues), mode thinking hybride, dense et MoE. Apache 2.0.",
    license: "Apache-2.0",
    contextWindow: "128k",
    releaseDate: "2025-04",
    releaseYear: 2025,
    ...
    variants: [
      ...
      { size: "235B MoE", params: 235, tag: "qwen3:235b-a22b", quants: QUANTS_BIG, storageGb: 142.0, instruct: true },
    ],
  },
  {
    id: "qwen3-coder",
    name: "Qwen3-Coder",
    brand: "Alibaba / Qwen",
    description: "Modèle agentic-coding MoE optimisé pour les workflows de développement (256k contexte natif).",
    license: "Apache-2.0",
    contextWindow: "256k",
    releaseDate: "2025-07",
    releaseYear: 2025,
    ...
    instruct: true,
    variants: [
      { size: "30B MoE (A3B)", params: 30, tag: "qwen3-coder:30b", quants: QUANTS_BIG, storageGb: 19.0, instruct: true },
    ],
  },
  {
    id: "qwq",
    name: "QwQ",
    brand: "Alibaba / Qwen",
    description: "Modèle de raisonnement profond spécialisé mathématiques, logique et résolution de problèmes complexes.",
    license: "Apache-2.0",
    contextWindow: "128k",
    releaseDate: "2025-03",
    releaseYear: 2025,
  ...
  },
  {
    ...
    finetunable: true,
    variants: [
      { size: "0.5B", params: 0.5, tag: "qwen2.5-coder:0.5b", quants: QUANTS_SMALL, storageGb: 0.4, instruct: true },
      { size: "1.5B", params: 1.5, tag: "qwen2.5-coder:1.5b", quants: QUANTS_SMALL, storageGb: 0.98, instruct: true },
      { size: "3B", params: 3, tag: "qwen2.5-coder:3b", quants: QUANTS_SMALL, storageGb: 1.9, instruct: true },
  ...
  },
  {
    ...
    finetunable: true,
    variants: [
      { size: "0.5B", params: 0.5, tag: "qwen2.5:0.5b", quants: QUANTS_SMALL, storageGb: 0.4, instruct: true },
      { size: "1.5B", params: 1.5, tag: "qwen2.5:1.5b", quants: QUANTS_SMALL, storageGb: 0.98, instruct: true },
      { size: "3B", params: 3, tag: "qwen2.5:3b", quants: QUANTS_SMALL, storageGb: 1.9, instruct: true },
      { size: "7B", params: 7, tag: "qwen2.5:7b", quants: QUANTS_SMALL, storageGb: 4.7, instruct: true },
      { size: "14B", params: 14, tag: "qwen2.5:14b", quants: QUANTS_BIG, storageGb: 9.0, instruct: true },
      { size: "32B", params: 32, tag: "qwen2.5:32b", quants: QUANTS_BIG, storageGb: 20.0, instruct: true },
      { size: "72B", params: 72, tag: "qwen2.5:72b", quants: QUANTS_BIG, storageGb: 43.0, instruct: true },
    ],
  },
  {
    id: "qwen2-vl",
    ...
    finetunable: true,
    variants: [
      { size: "2B", params: 2, tag: "qwen2-vl:2b", quants: QUANTS_SMALL, storageGb: 1.5, instruct: true },
      { size: "7B", params: 7, tag: "qwen2-vl:7b", quants: QUANTS_SMALL, storageGb: 4.5, instruct: true },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "DeepSeek-R1",
    brand: "DeepSeek",
    description: "Modèles raisonneurs officiels capables de réflexion logique étape par étape (1.5B à 671B).",
    license: "MIT",
    contextWindow: "128k",
    releaseDate: "2025-01",
    releaseYear: 2025,
    ...
    variants: [
      ...
      { size: "671B MoE", params: 671, tag: "deepseek-r1:671b", quants: QUANTS_BIG, storageGb: 404.0, instruct: true },
    ],
  },
  {
    id: "deepseek-v3",
    ...
    instruct: true,
    variants: [
      { size: "671B MoE", params: 671, tag: "deepseek-v3:671b", quants: QUANTS_BIG, storageGb: 404.0, instruct: true },
    ],
  },
  {
    ...
    variants: [
      ...
      { size: "236B", params: 236, tag: "deepseek-coder-v2:236b", quants: QUANTS_BIG, storageGb: 142.0, instruct: true },
    ],
  },
  {
    id: "deepseek-ocr",
    ...
    vision: true,
    variants: [
      { size: "3B", params: 3, tag: "deepseek-ocr:3b", quants: QUANTS_SMALL, storageGb: 1.9, instruct: false },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "Llama 4",
    brand: "Meta",
    description: "Famille MoE multimodale de Meta (texte + image). Scout (109B/17B actifs) et Maverick (400B/17B actifs).",
    ...
    variants: [
      ...
      { size: "Maverick 400B MoE", params: 400, tag: "llama4:maverick", quants: QUANTS_BIG, storageGb: 240.0, instruct: true },
    ],
  },
  {
    id: "llama3.3",
    ...
    finetunable: true,
    variants: [
      { size: "70B", params: 70, tag: "llama3.3:70b", quants: QUANTS_BIG, storageGb: 42.0, instruct: true },
    ],
  },
  {
    id: "llama3.2",
  ...
  },
  {
    ...
    finetunable: true,
    variants: [
      { size: "11B Vision", params: 11, tag: "llama3.2-vision:11b", quants: QUANTS_BIG, storageGb: 7.9, instruct: true },
      { size: "90B Vision", params: 90, tag: "llama3.2-vision:90b", quants: QUANTS_BIG, storageGb: 55.0, instruct: true },
    ],
  },
  {
    id: "llama3.1",
    ...
    finetunable: true,
    variants: [
      { size: "8B", params: 8, tag: "llama3.1:8b", quants: QUANTS_SMALL, storageGb: 4.9, instruct: true },
      { size: "70B", params: 70, tag: "llama3.1:70b", quants: QUANTS_BIG, storageGb: 42.0, instruct: true },
      { size: "405B", params: 405, tag: "llama3.1:405b", quants: QUANTS_BIG, storageGb: 243.0, instruct: true },
    ],
  },
  ...
  },
  {
    ...
    finetunable: true,
    variants: [
      { size: "12B", params: 12, tag: "mistral-nemo:12b", quants: QUANTS_BIG, storageGb: 7.1, instruct: true },
    ],
  },
  {
    id: "codestral",
  ...
  },
  {
    ...
    instruct: true,
    variants: [
      { size: "5.6B", params: 5.6, tag: "phi4-multimodal", quants: QUANTS_SMALL, storageGb: 3.4, instruct: true },
    ],
  },
  ...
  },
  {
    ...
    instruct: true,
    variants: [
      { size: "30B MoE (A3B)", params: 30, tag: "glm-4.7-flash", quants: QUANTS_BIG, storageGb: 19.0, instruct: true },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    brand: "NVIDIA",
    description: "Hybrid Mamba2-Transformer MoE (31.6B total, ~3.6B actifs) pour workflows agentiques à 1M tokens.",
    ...
    instruct: true,
    variants: [
      { size: "30B MoE (A3.6B)", params: 30, tag: "nemotron-nano", quants: QUANTS_BIG, storageGb: 19.0, instruct: true },
    ],
  },
  {
    ...
    brand: "NVIDIA",
    description: "Llama 3.1 70B customisé par NVIDIA pour des réponses plus utiles et performantes.",
    license: "Llama 3.1 Community",
    contextWindow: "128k",
    releaseDate: "2024-10",
    releaseYear: 2024,
    instruct: true,
    variants: [
      { size: "70B", params: 70, tag: "nemotron:70b", quants: QUANTS_BIG, storageGb: 42.0, instruct: true },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    name: "Kimi K2",
    brand: "Moonshot AI",
    description: "MoE 1T paramètres, architecture frontier pour orchestration multi-agents. Cloud uniquement via Ollama.",
    ...
    instruct: true,
    variants: [
      { size: "1T MoE (Cloud)", params: 1000, tag: "kimi-k2:cloud", quants: ["cloud"], storageGb: 0, instruct: true },
    ],
  },
  {
    id: "kimi-k3",
    name: "Kimi K3",
    brand: "Moonshot AI",
    description: "MoE 2,8T paramètres, fenêtre de contexte 1M tokens, multimodal natif. Nécessite un compte Ollama cloud (Pro/Max).",
    license: "Kimi License",
    contextWindow: "1M",
    releaseDate: "2026-07",
    releaseYear: 2026,
 ...
 */
export async function fetchLiveHuggingFaceModels(query: string = "gguf"): Promise<ModelFamily[]> {
  try {
