    ...
    <div style={containerStyle}>
      <VoicePresetBar
        ...
        settings={{
          ...
          speed, pitch, energy, clarity,
          pauseScale, temperature, expressive,
          instruct,
        }}
        ...
        {settingsOpen && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '16px' }}>
            ...
            >
              ...
              <span>
                ...
                <span style={{ display: 'block', fontSize: 11, color: 'var(--text-faint)', marginTop: 2 }}>
                  Le modèle s'appuie sur l'audio de référence <em>et</em> sa transcription :
                  il reprend le rythme et les inflexions, pas seulement le timbre.
                  Décoché, la phrase est lue platement.
                </span>
              </span>
            </label>
            <SliderField
            ...
            <p style={{ fontSize: 11, color: 'var(--text-faint)', lineHeight: 1.5, margin: 0 }}>
              Les quatre réglages ci-dessous s'appliquent au signal rendu, pas à la façon
              dont le modèle choisit de parler — ils fonctionnent donc sur tous les moteurs,
              y compris ceux qui n'exposent aucun de ces contrôles.
            </p>
            <SliderField
