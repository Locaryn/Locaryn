...
export const VOICE_STYLES = [
  { id: "narrator", label: "Narrateur", icon: "📖", desc: "Clair, posé, documentaire", prompt: "Voix de narrateur : claire, posée, ton documentaire" },
  { id: "conversational", label: "Conversationnel", icon: "💬", desc: "Naturel, chaleureux, quotidien", prompt: "Voix conversationnelle : naturelle, chaleureuse, ton quotidien" },
  { id: "newscaster", label: "Journaliste", icon: "📰", desc: "Professionnel, articulé, neutre", prompt: "Voix de journaliste : professionnelle, articulée, ton neutre" },
  { id: "character", label: "Personnage", icon: "🎭", desc: "Expressif, théâtral, varié", prompt: "Voix de personnage : expressive, théâtrale, ton varié" },
  { id: "whisper", label: "Chuchotement", icon: "🤫", desc: "Doux, intime, proche", prompt: "Chuchotement : doux, intime, très proche du micro" },
  { id: "energetic", label: "Énergique", icon: "⚡", desc: "Rapide, enthousiaste, dynamique", prompt: "Voix énergique : rapide, enthousiaste, ton dynamique" },
];
          ...
          {VOICE_STYLES.map((style) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontSize: '11px', color: 'var(--text-faint)', textAlign: 'center', marginTop: '4px', lineHeight: 1.2 }}>
                  {style.desc}
                </span>
              </button>
            );
