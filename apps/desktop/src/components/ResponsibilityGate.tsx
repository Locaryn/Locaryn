  ...
  return (
    ...
    >
      ...
      <ul className="locaryn-gate-list">
        <li>
          Vous êtes <strong>seul responsable</strong> du contenu généré et de son usage.
        </li>
        <li>
          Vous vous engagez à respecter <strong>les lois applicables</strong> et les droits des
          tiers.
        </li>
        <li>
          L'application n'est qu'un outil et <strong>décline toute responsabilité</strong> pour les
