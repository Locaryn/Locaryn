                      ...
                      [
                        {
                          icon: "image",
                          label: "Images",
                          repo: "Locaryn/extension-image",
                        },
                        { icon: "video", label: "Vidéo", repo: "Locaryn/extension-video-gen" },
                        { icon: "cube", label: "3D", repo: "Locaryn/extension-3d-gen" },
                        { icon: "mic", label: "Synthèse vocale", repo: "Locaryn/extension-voice-tts" },
                        { icon: "music", label: "Musique", repo: "Locaryn/extension-music-gen" },
                        {
                          icon: "search",
                          label: "Vision et OCR",
                          repo: "Locaryn/extension-vision-ocr",
                        },
                        {
                          icon: "models",
                          label: "Documents et RAG",
                          repo: "Locaryn/extension-rag-qa",
                        },
                        {
                          icon: "translate",
                          label: "Traduction",
                          repo: "Locaryn/extension-translation",
                        },
                        {
                          icon: "chart",
                          label: "Analyse de texte",
                          repo: "Locaryn/extension-text-analysis",
                        },
                        { icon: "server", label: "SSH", repo: "Locaryn/extension-ssh" },
                        {
                          icon: "cloud",
                          label: "Tunnel Remote",
                          repo: "Locaryn/extension-travel-tunnel",
                        },
                        {
                          icon: "shield",
                          label: "Atelier LoRA",
                          repo: "Locaryn/extension-model-training",
                        },
