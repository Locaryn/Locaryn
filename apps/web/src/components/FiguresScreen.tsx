...
/**
 * Les figures, sur leur écran — le même que sur le téléphone. Un rôle et un
 * agencement : des consignes, un modèle, une phrase d'ouverture. Elles vivent
 * sur le serveur : ce qu'on configure ici se retrouve sur l'ordinateur.
 */
export function FiguresScreen({ onBack, onOpenChat }: Props) {
  ...
  const reload = useCallback(async () => {
    try {
      ...
      // pour reprendre d'un clic. Une figure muette ne bloque pas ses voisines.
