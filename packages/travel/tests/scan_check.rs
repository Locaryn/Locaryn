...
//!
//! ```text
//! LOCARYN_QR_OUT=/tmp/qr.txt cargo test -p locaryn-travel --test scan_check -- --ignored
//! ```
#[test]
#[ignore = "writes a file for an external scanner"]
fn emit_a_code_for_a_real_reader() {
    let link = "locaryn://travel?v=1&m=travel&u=aHR0cHM6Ly9wZXRpdGUtY2hvc2UtYWJjZC0xMjM0LnRyeWNsb3VkZmxhcmUuY29t&e=1800000600&k=AbCdEfGhIj&s=MEUCIQDxYnVzZWQtc2lnbmF0dXJlLWJ5dGVzLWhlcmU";
    let (w, m) = locaryn_travel::qr::matrix(link).unwrap();
