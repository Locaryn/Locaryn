...
-- config) is converted to Locaryn's layout at install time, so nothing on disk
...
--
-- Rows written before this migration are Locaryn-native by definition.
ALTER TABLE extensions ADD COLUMN ecosystem TEXT NOT NULL DEFAULT 'locaryn';
